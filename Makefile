...
ASM_SOURCES_F0 = $(CMSIS_PATH)/startup_stm32f051x8.s
LDSCRIPT_F0 = $(CMSIS_PATH)/STM32F051R8Tx_FLASH.ld
...
$(BUILD_DIR)/startup_stm32f051x8.o: $(ASM_SOURCES_F0) Makefile | $(BUILD_DIR)
	$(AS) -c $(CFLAGS_F0) $< -o $@
